...
export function Logo({
  ...
  return (
    <span className={cn("flex items-center gap-2.5", className)}>
      <LogoMark className="h-10 w-auto shrink-0 text-graphite" />
      <span className="flex flex-col leading-none">
        <LogoWordmark className="h-[1.15rem] w-auto text-graphite" />
        {!compact && (
...
/** Stacked lockup, exactly as AGBA supplied it. Used in the footer. */
export function LogoStacked({ className }: { className?: string }) {
  return (
    <span className={cn("inline-flex flex-col items-center", className)}>
      <svg
        viewBox="316.05 128.08 133.09 121.25"
        aria-hidden="true"
        className="h-28 w-auto text-graphite"
      >
      <path
        d="M381.89,159.98l-22.5,38c6.01.52,11.25.2,16.69.13l5.71-.06,8.15,14.35-57.64.04,49.47-84.36,49.75,84.28-18.56.1-16.67-28.3-14.4-24.18ZM351.46,202.22l30.46-51.66,34.02,57.59,7.5-.16-41.67-70.54-41.5,70.7,41.73.06-3.27-5.83-27.29-.15Z"
        className="fill-current"
